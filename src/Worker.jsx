...
const styles = {
  ...
  floorGrid: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 7, gridAutoRows: "72px" },
  floorBtn: { background: "#141414", border: "1px solid #1e1e1e", borderRadius: 12, height: "72px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, fontWeight: 700, color: "#fff", cursor: "pointer", position: "relative", overflow: "hidden", transition: "all 0.15s" },
