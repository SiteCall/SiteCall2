...
const styles = {
  ...
  floorGrid: { display: "grid", gridTemplateColumns: "repeat(2, 72px)", gap: 7, justifyContent: "center" },
  floorBtn: { background: "#141414", border: "1px solid #1e1e1e", borderRadius: 12, width: "72px", height: "72px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, fontWeight: 700, color: "#fff", cursor: "pointer", position: "relative", overflow: "hidden", transition: "all 0.15s" },
  floorBtnSelected: { border: "3px solid #2563eb", transform: "scale(1.08)", fontSize: 24, boxShadow: "0 0 0 2px rgba(37,99,235,0.15)", zIndex: 1 },
